...
- `php-references/accepted-psrs.md` - Detailed PSR descriptions
- `php-references/when-to-use.md` - Decision matrix for PSR selection
- `php-references/compatibility.md` - Inter-PSR relationships
- `php-references/php-fig-process.md` - How PSRs are created
- `php-assets/psr-selection-guide.md` - Selection guide template
