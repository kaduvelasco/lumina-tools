#!/usr/bin/env bash
# =============================================================================
# Script Name     : pos-install-zorin-lite.sh
# Description     : Post-install routine for ZorinOS 18.1 Lite (XFCE)
# Version         : 1.0.0
# =============================================================================
...
run_post_install() {
    ...
    log_file="$(start_log "pos-install-zorin-lite")"
    ...
    success "Pós-instalação do ZorinOS Lite concluída."
